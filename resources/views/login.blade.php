...
<div class="row header" style="text-align:center;color:white;font-weight:bold;font-size:50px;font-family: FreeSans,serif">
    <h1>74YOU</h1>
</div>
<style>
    body {
        background: linear-gradient(to right, cornflowerblue , cornflowerblue);
        min-height: 100vh;
        margin: 0;
        padding: 0;
        height: 100vh;
